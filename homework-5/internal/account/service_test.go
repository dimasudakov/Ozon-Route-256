...
func TestBankAccountService_CreateBankAccount(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			mockRepo: func(repository *mock_account.MockRepository) {
				repository.EXPECT().CreateBankAccount(gomock.Any()).Return(createdBankAccount, nil)
			},
			expectedError: nil,
		},
		{
		...
		},
		{
			...
			expectedResult: nil,
			mockRepo: func(repository *mock_account.MockRepository) {
				repository.EXPECT().CreateBankAccount(gomock.Any()).Return(nil, apperr.NewInternalServerError("Internal server error"))
			},
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := fixture.service.CreateBankAccount(&tc.requestPayload)
...
func TestBankAccountService_GetBankAccountById(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			mockRepo: func(repository *mock_account.MockRepository) {
				repository.EXPECT().GetBankAccountByID(expectedAccount.ID).Return(expectedAccount, nil)
			},
		...
		},
		{
			...
			mockRepo: func(repository *mock_account.MockRepository) {
				repository.EXPECT().GetBankAccountByID(notFoundId).
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := fixture.service.GetBankAccountById(tc.requestID)
...
func TestBankAccountService_UpdateBankAccount(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			requestPayload: *bankAccount,
			mockRepo: func(repository *mock_account.MockRepository) {
				repository.EXPECT().UpdateBankAccount(bankAccount.ID, bankAccount).Return(bankAccount, nil)
			},
			expectedResult: bankAccount,
			expectedError:  nil,
		},
		...
		},
		{
			...
			requestPayload: *bankAccount,
			mockRepo: func(repository *mock_account.MockRepository) {
				repository.EXPECT().UpdateBankAccount(notFoundId, bankAccount).Return(
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := fixture.service.UpdateBankAccount(tc.requestID, &tc.requestPayload)
...
func TestBankAccountService_DeleteBankAccount(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			requestID: bankAccount.ID,
			mockRepo: func(repository *mock_account.MockRepository) {
				repository.EXPECT().DeleteBankAccount(bankAccount.ID).Return(bankAccount, nil)
			},
			expectedResult: bankAccount,
			expectedError:  nil,
		},
		{
			...
			requestID: notFoundId,
			mockRepo: func(repository *mock_account.MockRepository) {
				repository.EXPECT().DeleteBankAccount(notFoundId).Return(
					nil, apperr.NewNotFoundError(fmt.Sprintf("Bank account with ID: %d not found", 10329032)))
			},
			expectedResult: nil,
			expectedError:  apperr.NewNotFoundError(fmt.Sprintf("Bank account with ID: %d not found", 10329032)),
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := fixture.service.DeleteBankAccount(tc.requestID)
